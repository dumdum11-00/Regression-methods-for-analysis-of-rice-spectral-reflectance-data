...
# %%
grid_values = {'alpha': [1,0.1,0.01,0.001,0.0001,0],
            "fit_intercept": [True, False], 
            "solver": ['svd', 'cholesky', 'lsqr', 'sparse_cg', 'sag', 'saga']}
grid_ridge_performance = GridSearchCV(Ridge(), param_grid = grid_values, scoring = 'r2')
grid_ridge_performance.fit(X_train_pca, y_train)
...
grid_values = {'alpha': [1,0.1,0.01,0.001,0.0001,0],
            ...
            "solver": ['svd', 'cholesky', 'lsqr', 'sparse_cg', 'sag', 'saga']}
grid_ridge_performance = GridSearchCV(Ridge(), param_grid = grid_values, scoring = 'r2')
grid_ridge_performance.fit(X_train_pca, y1_train)
grid_ridge_performance.best_params_
...
grid_values = {'alpha': [1,0.1,0.01,0.001,0.0001,0],
            ...
            "solver": ['svd', 'cholesky', 'lsqr', 'sparse_cg', 'sag', 'saga']}
grid_ridge_performance = GridSearchCV(Ridge(), param_grid = grid_values, scoring = 'r2')
grid_ridge_performance.fit(X_train_pca, y2_train)
grid_ridge_performance.best_params_


# %%
model =  Ridge(alpha= 0.0001, fit_intercept= True, solver= 'saga')
model.fit(X_train_pca,y_train)

# %%
model2 =  Ridge(alpha= 0.0001, fit_intercept= True, solver= 'saga')
model2.fit(X_train_pca,y1_train)

# %%
model3 =  Ridge(alpha= 0.0001, fit_intercept= True, solver= 'saga')
